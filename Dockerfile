...
# BEGIN - While elasticsearch-cloud-kubernetes-6.2.1 is not available on maven repo
COPY elasticsearch-cloud-kubernetes-6.2.1-SNAPSHOT.zip ${HOME}
ENV ES_CLOUD_K8S_URL=file://${HOME}/elasticsearch-cloud-kubernetes-6.2.1-SNAPSHOT.zip
# END
