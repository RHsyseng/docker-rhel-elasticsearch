...
# BEGIN - While elasticsearch-cloud-kubernetes-6.1.2 is not available on maven repo
COPY elasticsearch-cloud-kubernetes-6.1.2-SNAPSHOT.zip ${HOME}
ENV ES_CLOUD_K8S_URL=file://${HOME}/elasticsearch-cloud-kubernetes-6.1.2-SNAPSHOT.zip
# END
